...
public class PlaylistRepository {
    ...
    public void getUserPlaylist( String username ) {
        ...
        TypedQuery<ICAI.entity.Playlists> query = entityManager.createQuery("select p.name from Playlists p where p.user.username =?1", ICAI.entity.Playlists.class);
        query.setParameter(1, username);

        List<ICAI.entity.Playlists> playList = query.getResultList();
